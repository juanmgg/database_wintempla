...
#define CONNECTION_STRING L"DRIVER={SQL Server};server=Juan-PC\\SQLEXPRESS;database=DataBaseSchool;Trusted_Connection=yes"
// #define CONNECTION_STRING L"DRIVER={SQL Server};server=(localdb)\\MSSQLLocalDB;database=MyDabatase;Trusted_Connection=yes"
#define CONNECTUSR_STRING L"DRIVER={SQL Server};server=Juan-PC\\SQLEXPRESS;database=DataBaseSchool;UID=%s;PWD=%s"
